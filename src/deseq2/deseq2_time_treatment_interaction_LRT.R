...
### 12 hr ###
paste("12hr wald with padj<0.1")
qmp_12hrs_res_0.1 <- results(dds_res, test="Wald",
                         lfcThreshold = 1, alpha = 0.1,
                         name = "treatment_QMP_vs_control")
summary(qmp_12hrs_res_0.1)
paste("12hr wald with padj<0.05")
...
### 24 hr ###
paste("24hr wald with padj<0.1")
qmp_24hrs_res_0.1 <- results(dds_res, test="Wald",
                         lfcThreshold = 1, alpha = 0.1,
                         name = "timepoint24.treatmentQMP")
summary(qmp_24hrs_res_0.1)
paste("24hr wald with padj<0.05")
...
### 48 hr ###
paste("48hr wald with padj<0.1")
qmp_48hrs_res_0.1 <- results(dds_res, test="Wald",
                         lfcThreshold = 1, alpha = 0.1,
                         name = "timepoint48.treatmentQMP")
summary(qmp_48hrs_res_0.1)
paste("48hr wald with padj<0.05")
...
### 120 hr ###
paste("120hr wald with padj<0.1")
qmp_120hrs_res_0.1 <- results(dds_res, test="Wald",
                          lfcThreshold = 1, alpha = 0.1,
                          name = "timepoint120.treatmentQMP")
summary(qmp_120hrs_res_0.1)
paste("120hr wald with padj<0.05")
